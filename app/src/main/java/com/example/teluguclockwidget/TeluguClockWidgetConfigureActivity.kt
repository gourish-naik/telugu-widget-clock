...
class TeluguClockWidgetConfigureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (appWidgetId == AppWidgetManager.INVALID_APPWIDGET_ID) {
            // If launched from app drawer, just show preview/settings
            // finish() // Don't finish
            // return
        }
    ...
    private fun updatePreview() {
        try {
            ...
            // overlayTheme is already defined above
    ...
    private fun saveSettings() {
        ...
        if (appWidgetId != AppWidgetManager.INVALID_APPWIDGET_ID) {
            ...
            Toast.makeText(this, "Settings saved (Preview)", Toast.LENGTH_SHORT).show()
            // Optional: finish() if you want to close after save in preview mode
        }
    }
}
